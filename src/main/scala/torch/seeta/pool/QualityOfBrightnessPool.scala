 ...
 */
  /**
    ...
    @throws[Exception]
    override def destroyObject(pooledObject: PooledObject[QualityOfBrightness]): Unit = {
     ...
     * @return
     */
    override def validateObject(pooledObject: PooledObject[QualityOfBrightness]): Boolean = {
     ...
     */
    @throws[Exception]
    override def activateObject(pooledObject: PooledObject[QualityOfBrightness]): Unit = {
      val instance = pooledObject.getObject
      val impl = instance.impl
    }
