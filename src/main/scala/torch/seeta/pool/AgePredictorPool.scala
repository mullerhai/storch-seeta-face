 ...
 */
  /**
    ...
    @throws[Exception]
    override def destroyObject(pooledObject: PooledObject[AgePredictor]): Unit = {
     ...
     * @return
     */
    override def validateObject(pooledObject: PooledObject[AgePredictor]): Boolean = {
     ...
     */
    @throws[Exception]
    override def activateObject(pooledObject: PooledObject[AgePredictor]): Unit = {
      val instance = pooledObject.getObject
      val impl = instance.impl
    }
