 ...
 */
  /**
    ...
    @throws[Exception]
    override def destroyObject(pooledObject: PooledObject[EyeStateDetector]): Unit = {
     ...
     * @return
     */
    override def validateObject(pooledObject: PooledObject[EyeStateDetector]): Boolean = {
     ...
     */
    @throws[Exception]
    override def activateObject(pooledObject: PooledObject[EyeStateDetector]): Unit = {
      val instance = pooledObject.getObject
      val impl = instance.impl
    }
