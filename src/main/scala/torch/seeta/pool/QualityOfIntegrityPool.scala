 ...
 */
  /**
    ...
    @throws[Exception]
    override def destroyObject(pooledObject: PooledObject[QualityOfIntegrity]): Unit = {
     ...
     * @return
     */
    override def validateObject(pooledObject: PooledObject[QualityOfIntegrity]): Boolean = {
     ...
     */
    @throws[Exception]
    override def activateObject(pooledObject: PooledObject[QualityOfIntegrity]): Unit = {
      val instance = pooledObject.getObject
      val impl = instance.impl
    }
