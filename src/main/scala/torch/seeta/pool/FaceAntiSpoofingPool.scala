 ...
 */
    ...
    @throws[Exception]
    override def destroyObject(pooledObject: PooledObject[FaceAntiSpoofing]): Unit = {
     ...
     * @return
     */
    override def validateObject(pooledObject: PooledObject[FaceAntiSpoofing]): Boolean = {
     ...
     */
    @throws[Exception]
    override def activateObject(pooledObject: PooledObject[FaceAntiSpoofing]): Unit = {
      val instance = pooledObject.getObject
      val impl = instance.impl
    }
     ...
     */
    @throws[Exception]
    override def passivateObject(pooledObject: PooledObject[FaceAntiSpoofing]): Unit = {

      //nothing
    }
  }, config.asInstanceOf[GenericObjectPoolConfig[FaceAntiSpoofing]]) {
}