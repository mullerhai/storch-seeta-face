...
import torch.seeta.sdk.{EyeStateDetector, QualityOfPose}
 ...
 */
  /**
    ...
    @throws[Exception]
    override def destroyObject(pooledObject: PooledObject[QualityOfPose]): Unit = {
     ...
     * @return
     */
    override def validateObject(pooledObject: PooledObject[QualityOfPose]): Boolean = {
     ...
     */
    @throws[Exception]
    override def activateObject(pooledObject: PooledObject[QualityOfPose]): Unit = {
      val instance = pooledObject.getObject
      val impl = instance.impl
    }
  ...
  }, config.asInstanceOf[GenericObjectPoolConfig[QualityOfPose]]) {
}