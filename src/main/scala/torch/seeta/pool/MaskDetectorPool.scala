 ...
 */
 /**
    ...
    @throws[Exception]
    override def destroyObject(pooledObject: PooledObject[MaskDetector]): Unit = {
     ...
     * @return
     */
    override def validateObject(pooledObject: PooledObject[MaskDetector]): Boolean = {
     ...
     */
    @throws[Exception]
    override def activateObject(pooledObject: PooledObject[MaskDetector]): Unit = {
      val instance = pooledObject.getObject
      val impl = instance.impl
    }
