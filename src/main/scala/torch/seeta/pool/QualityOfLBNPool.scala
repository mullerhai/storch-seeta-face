 ...
 */
 /**
    ...
    @throws[Exception]
    override def destroyObject(pooledObject: PooledObject[QualityOfLBN]): Unit = {
     ...
     * @return
     */
    override def validateObject(pooledObject: PooledObject[QualityOfLBN]): Boolean = {
     ...
     */
    @throws[Exception]
    override def activateObject(pooledObject: PooledObject[QualityOfLBN]): Unit = {
      val instance = pooledObject.getObject
      val impl = instance.impl
    }
