 ...
 */
  /**
    ...
    @throws[Exception]
    override def destroyObject(pooledObject: PooledObject[QualityOfResolution]): Unit = {
     ...
     * @return
     */
    override def validateObject(pooledObject: PooledObject[QualityOfResolution]): Boolean = {
     ...
     */
    @throws[Exception]
    override def activateObject(pooledObject: PooledObject[QualityOfResolution]): Unit = {
      val instance = pooledObject.getObject
      val impl = instance.impl
    }
